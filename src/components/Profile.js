...
export default function Profile () {
    ...
    const [eth_in_usd, updateETHValue] = useState(0);
    ...
    useEffect(() => {
        ...
        async function onPageLoad () {
            ...
            let ehtInusd = await contract.getETHfeeUSD();
            updateETHValue(ehtInusd);
        };
    ...
    return (
        <div className="profileClass" style={{"min-height":"100vh"}}>
            ...
            <div className="flex text-center flex-col mt-11 md:text-2xl text-white">
                ...
                <div>
                    <h2 className="font-bold">1ETH = {parseInt(eth_in_usd, 10)}USD</h2>                      
                </div>
            </div>
